...
import { Agregar_Jugador_Al_EquipoController,crearEquipoController, Traer_EquiposController, Eliminar_EquipoController , 
...
router.get("/equipo/jugadores/:id",ObtenerJugadoresporEquipoController);
